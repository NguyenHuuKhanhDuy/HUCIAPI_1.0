namespace Common.Constants
{
    ...
    {
        public const string INVALID_CUSTOMER_ID = "Invalid id of customer";
        public const string INVALID_TOTAL_ORDER = "Invalid total order";
        public const string INVALID_VOUCHER_ID = "Invalid id of voucher";
        public const string INVALID_ORDER_DISCOUNT = "Invalid discount of order";
        public const string INVALID_ORDER_STATUS_ID = "Invalid id of status order";
        ...
        public const string INVALID_PAYMENT_METHOD_ID = "Invalid id of payment method";
        ...
        public const string PAYMENT_METHOD_NOT_EXISTS = "Source order not exists";
